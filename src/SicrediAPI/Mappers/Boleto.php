...
class Boleto
{
    public static function mapCreateBoleto(BoletoDomain $boleto)
    {
        ...
        if (!empty($boleto->getBeneficiary()->getName())) {
        ...
        if (!empty($boleto->getMessages())) {
            $base =  array_merge($base, (new Messages($boleto->getMessages()))->toArray());
        }

        if (!empty($boleto->getInformation())) {
            $base =  array_merge($base, (new Information($boleto->getInformation()))->toArray());
        }
    ...
    public static function mapFromQuery($data): BoletoDomain
    {
        ...
        if (!empty($data['descontos'])) {
            ...
            $discountConfiguration = new DiscountConfigurationDomain(
                $discounts,
